...
USTRUCT(BlueprintType) struct FUIWidgetRow : public FTableRowBase
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite) TSubclassOf<UAuraUserWidget> MessageWidget;
...
public:
	...
	UPROPERTY(BlueprintAssignable, Category = "GAS|Attributes" )FMessageWidgetRowSignature MessageWidgetRowDelegate;
